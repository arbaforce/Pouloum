...
var htmlcode = `
            <div class="newnavbar">
                ...
                <div>
                    <a class="nav-link font-weight-bold text-center" href="home_page.html">Accueil</a>
                </div>
                <div>
                    <a class="nav-link dropdown-toggle font-weight-bold text-center" href="#" id="navbar_profile_dropdown_links" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Profil</a>
                ...
                <div>
                    <a class="nav-link font-weight-bold text-center" href="events_browser.html">Chercher</a>
                </div>
                <div>
                    <a class="nav-link dropdown-toggle font-weight-bold text-center" href="#" id="navbar_organize_dropdown_links" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Organiser</a>
                ...
                <div>
                    <a class="nav-link font-weight-bold text-center" href="activities_browser.html">Activité</a>
                </div>
                <div>
