...
function addResultDemo() {
    ...
    addResult([{name:"Basketball", url:"", level:"débutant"}], {name:"Claude", url:""}, "Tête d'Or", "aujourd'hui", "une semaine", data_participants, "rempli", "");
}

function addResult(data_activities, data_organizer, data_place, data_date, data_duration, data_participants, data_status, data_eventurl) {
